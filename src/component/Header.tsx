    ...
    return (
        <div className='w-screen sm:h-32 h-24 bg-[#FEFEFF] sm:px-28 px-3  flex justify-between items-center'>
            ...
            <ul className=' font-normal  font-sans sm:flex hidden gap-10 text-gray-700' style={{ fontFamily: 'Poppins' }}>
                ...
                <li className='border-b-2 font-semibold text-xl border-[#EE619C] w-20 flex justify-center'> <a href="/register"> Sign Up</a></li>
                <li className='border-b-2 font-semibold text-xl border-[#EE619C] w-20 flex justify-center'> <a href="/login"> Login</a></li>
