...
function Hero() {
  return (
    ...
    <div className=" p-8 flex flex-col sm:gap-4 gap-2 justify-center items-center sm:text-left text-center">
        ...
        <button className='flex justify-center items-center sm:px-5 sm:py-3 px-3 py-1 transition-all duration-300 bg-[#EE619C] font-bold text-white rounded-full hover:bg-white hover:text-[#EE619C] hover:border hover:border-[#EE619C]'>Read more</button>
    </div>
    </div>
  )
}
